...
public class SpriteSheet {
	...
	public SpriteSheet(String url, int tileWidth, int tileHeight, boolean load) throws IOException{
		this(ImageService.loadImage(ImageService.RESOURCE_SPRITESHEETS + url), tileWidth, tileHeight, load);
	}
